          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-4xl font-bold text-emerald-600">
                Rs. {Math.round(cashInHistory.reduce((sum, record) => sum + parseFloat(record.amount || 0), 0))}
              </p>
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-lg font-bold text-green-600">Rs. {Math.round(record.amount)}</p>
                </div>
              </div>
            </div>
          ))}
